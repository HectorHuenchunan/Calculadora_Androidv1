...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnIgual.setOnClickListener{
            ...
            var validar : String = tv_num2.getText().toString();
            if (validar.isEmpty()){
                tv_resultado.setText(numero1.toString())
                tv_num1.setText("")
                tv_num2.setText("")
            }else {
                ...
                tv_resultado.setText(res.toString())
                tv_num1.setText(res.toString())
                tv_num2.setText("")
        ...
        btnBorrar.setOnClickListener{
            tv_num1.setText(numero1.toString())
            tv_num2.setText("")
            oper = 0
        }
    ...
    fun botonigual(view: View){
        var validar : String = tv_num2.getText().toString();
        if (validar.isEmpty()){
            tv_num2.setText(numero1.toString())
            //tv_num1.setText("")
        }else {
            var num2 = tv_num2.text.toString().toDouble()
            var res = 0.0
